...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen bg-white pt-32 flex items-center justify-center relative overflow-hidden scroll-mt-[100px]"
    >
      {/* Content */}
      <div className="relative z-10 text-center px-6 mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button
            ...
            className="px-6 py-3 rounded-full bg-green-600 hover:bg-green-700 text-white transition-all duration-300 flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-6 py-3 rounded-full border border-green-700 text-gray-600 hover:bg-green-700 hover:text-white transition-all duration-300"
          >
            View My Work
          </button>
        </div>
        ...
        <div className="flex gap-6 justify-center">
          <a
            ...
            className="text-gray-600 hover:text-green-600 p-2 transition-transform transform hover:scale-110"
            aria-label="GitHub"
          >
            <FaGithub size={24} />
          </a>
